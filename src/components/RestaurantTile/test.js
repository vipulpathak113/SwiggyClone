...
describe('<RestaurantTile /> spec', () => {
    ...
    it('assert Show More Tiles displays correct data', () => {
        ...
        expect(document.querySelector('.restaurant-tile-body-desc-outer').innerHTML).toBe('<div class="restaurant-tile-body-desc-ratings"><span class="star">☆</span><span>4.0</span></div><div>•</div><div>108 mins</div><div>•</div><div class="">₹1300 FOR TWO</div>')
    })
})
